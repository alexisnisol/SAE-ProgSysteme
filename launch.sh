...
javac --module-path ./lib --add-modules javafx.controls,javafx.fxml -cp "lib/*" -d bin src/model/*.java src/controller/*.java src/model/exception/*.java src/model/**/*.java src/view/*.java
